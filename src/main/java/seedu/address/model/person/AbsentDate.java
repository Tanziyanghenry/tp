...
public class AbsentDate {
    ...
    public static final String MESSAGE_CONSTRAINTS =
            "The absent date should be in the format DD-MM-YYYY and must be within the current year. "
                    + "Ensure the day is valid for the specified month "
    ...
    public static boolean isValidAbsentDate(String absentDate) {
        ...
        if (day > maxDay || year != CURRENT_YEAR) {
            return false;
        }
